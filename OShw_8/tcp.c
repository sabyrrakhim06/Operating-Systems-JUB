...
/*
 * The tcp_read() function behaves like read(), but restarts it
 * restarts after signal interrupts and on other short reads.
*/
...
/* 
 * The tcp_write() function behaves like write(), but restarts it
 * restarts after signal interrupts and on other short writes.
*/
